...
namespace Ayura.API.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IAppSettings appSettings, IAyuraDatabaseSettings settings, IMongoClient mongoClient, IOptions<AppSettings> appSettingsOptions, IPasswordHasher<string> passwordHasher)
        {
            ...
            {
                cfg.CreateMap<SignupRequest, User>();
            });
        ...
        public async Task<User> RegisterUser(SignupRequest signupRequest)
        {
            ...
            // Hash the password
            string hashedPassword = _passwordHasher.HashPassword(null, signupRequest.Password);
