...
public class ProfileRetrieveService : IProfileRetrieveService
{
    ...
    public ProfileRetrieveService(IAppSettings appSettings, IAyuraDatabaseSettings settings, IMongoClient mongoClient, IOptions<AppSettings> appSettingsOptions)
    {
        ...
        {
            cfg.CreateMap<User, ProfileDetailsDTO>().ReverseMap();
        });

        _mapper = mapperConfig.CreateMapper();
    }
    
    public async Task<ProfileDetailsDTO> RetrieveProfileDetails(string email)
    {
